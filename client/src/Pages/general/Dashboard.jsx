...
import { Play, Pause, MessageCircle, Share2, X } from 'lucide-react'
    ...
    try {
      ...
      const reelsWithProfiles = await Promise.all(
        shuffledReels.map(async (reel) => {
          ...
          try {
            const res = await api.get(`/users/FetchFoodPartner?id=${reel.PartnerId}`)
            return {
              ...reel,
          ...
          >
            ...
            >
              ...
              <div className="border-t mb-15 border-gray-200 dark:border-gray-800 pt-3 flex items-center gap-3">
                ...
                type='submit' className="text-blue-500 text-sm font-semibold hover:text-blue-600">{loading ? 'Posting...' : 'Post'}
